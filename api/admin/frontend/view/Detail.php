            ...
            <div class="container py-5">
                <div class="row g-4 mb-5">
                    <div class="col-lg-8 col-xl-9">
                        ...
                        <div class="row g-4">
                            <div class="col-lg-6">
                                <div class="text-center border rounded p-2" style="background-color: #fff;">
                            ...
                            <div class="col-lg-6">
                                <h1 class="fw-bold "style="font-family: Tahoma, Arial, sans-serif; font-size: 2.0rem; font-weight: bold;"><?=$product['TenSanPham']?></h1>
                                <br>
                                ...
                                <h2 class="fw-bold text-danger" style="font-family: Tahoma, Arial, sans-serif; font-size: 1.5rem;">
                                <?= number_format($product['GiaGoc'], 0, ',', '.') ?> ₫/kg
                                </h2>
                                ...
                                <nav>
                                    <div class="nav nav-tabs mb-3">
                                        ...
                                        <button class="nav-link border-white border-bottom-0" type="button" role="tab"
                                            ...
                                            aria-controls="nav-mission" aria-selected="false">Dánh giá</button>
                                    </div>
                                </nav>
                                <div class="tab-content mb-5">
                                            ...
                                            <div class="row g-4">
                                                <div class="col-6">
                                                    ...
                                                    <div class="row text-center align-items-center justify-content-center py-2">
                                                        <div class="col-6">
                                                            <p class="mb-0">Nơi xuất xứ </p>
                                                        </div>
                                                        <div class="col-6">
                                                            <p class="mb-0">Nông trại nông nghiệp</p>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="tab-pane" id="nav-mission" role="tabpanel" aria-labelledby="nav-mission-tab">
                                        <div class="d-flex">
                                            ...
                                            <div class="">
                                                <p class="mb-2" style="font-size: 14px;">15 / 08 / 2025 </p>
                                                ...
                                                <p>Trái cây tươi - giá cả hợp lý - giao hàng nhanh</p>
                                            </div>
                                        </div>
                                        <div class="d-flex">
                                            <img src="../public/img/avatar.jpg" class="img-fluid rounded-circle p-3" style="width: 100px; height: 100px;" alt="">
                                            <div class="">
                                                ...
                                                <p class="text-dark">Rau củ rất tươi ngon - giao rất nhanh </p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <form action="#">
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="border-bottom rounded">
                                            <input type="email" class="form-control border-0" placeholder="Tên Email *">
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="border-bottom rounded my-4">
                                            <textarea name="" id="" class="form-control border-0" cols="30" rows="8" placeholder="Đánh giá *" spellcheck="false"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                ...
                <div class="vesitable">
                    ...
                    <div class="owl-carousel vegetable-carousel justify-content-center">
                        <?php foreach($relateProduct as $p){?>
                        <div class="border border-primary rounded position-relative vesitable-item">
                            ...
                            <div class="p-4 pb-0 rounded-bottom">
                                ...
                                <div class="d-flex justify-content-between flex-lg-wrap">
                                    <p class="text-dark fs-5 fw-bold"><?=$p['GiaGoc'] ?>/ kg</p>
